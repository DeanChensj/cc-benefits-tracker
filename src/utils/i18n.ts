const translationsEn = {
  ...
  extStatus: 'Available now on the Chrome Web Store! Zero tracking, 100% local syncing.',
  extDownloadBtn: '🚀 Download from Chrome Web Store',
...
const translationsZh: typeof translationsEn = {
  ...
  extStatus: '已正式上架 Chrome Web Store！零数据采集，100% 本地优先同步。',
  extDownloadBtn: '🚀 前往 Chrome Web Store 下载',
