const translationsEn = {
  ...
  extHighlightAlertsDesc: 'Get instant statement credit and multiplier reminders on Uber, Saks, Amazon, and 50+ major sites.',
  ...
  extStatus: 'Inject active benefit reminders and multiplier alerts directly into checkout pages.',
  extDownloadBtn: 'Install Assistant',
...
const translationsZh: typeof translationsEn = {
  ...
  needCloudBadge: '需连云端',
  extHighlightAlerts: '商户结账智能提醒',
  extHighlightAlertsDesc: '访问 Uber、Grubhub、Saks 等 50+ 主流商户时，自动弹出最佳刷卡与报销方案。',
  ...
  extStatus: '在商户结账页面，自动呈现当前卡包的最佳刷卡报销与倍率提醒。',
  extDownloadBtn: '一键安装助手',
