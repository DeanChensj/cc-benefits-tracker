    ...
    <div className="fixed inset-0 bg-slate-950/40 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fade-in">
      <div className={`w-full max-w-sm rounded-2xl border p-6 text-center space-y-4 shadow-2xl animate-scale-up ${
        ...
        <div className="space-y-1">
          <h3 className={`text-sm font-black ${themeClass('text-white', 'text-slate-900')}`}>Confirm Deletion</h3>
          <p className="text-[11px] text-slate-505 leading-normal">
            Are you sure you want to delete <span className="font-bold text-slate-400 dark:text-white">"{cardName}"</span>?<br />
            This will permanently erase all logged benefits history for this card instance.
          </p>
        </div>
