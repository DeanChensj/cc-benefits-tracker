...
export function Toast({ message, type, theme, onUndo }: ToastProps) {
  ...
  return (
    <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 pointer-events-none animate-scale-up max-w-[90vw] w-fit shrink-0">
      <div className={`px-6 py-4 rounded-r-xl border border-l-[3.5px] text-sm font-black flex items-center justify-between gap-4 shadow-2xl backdrop-blur-xl transition-all duration-300 pointer-events-auto ${
